...
import { StyleSheet, View, FlatList, Button, Text, Linking, TextInput } from "react-native";
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        />
        <Text style={styles.textLinking}>Please write your name:</Text>
        <TextInput style={styles.input} placeholder='e.g. Join' onChangeText={(value) => setName(value)} />
        <Button
